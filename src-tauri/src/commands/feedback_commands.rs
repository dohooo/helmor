...
#[tauri::command]
pub async fn find_existing_helmor_workspace() -> CmdResult<Option<feedback::ExistingHelmorWorkspace>>
{
    run_blocking(feedback::find_existing_helmor_workspace).await
}
