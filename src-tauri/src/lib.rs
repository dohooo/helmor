...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::editor_commands::get_workspace_diff_stats,
            ...
            commands::workspace_commands::list_workspace_commits_ahead,
            commands::workspace_commands::resolve_workspace_merge_base,
