...
export function createOptimisticCreatingWorkspaceDetail(
	...
	return {
		...
		prSyncState: "none",
		prUrl: null,
		workspaceKind: row.workspaceKind ?? "worktree",
		archiveCommit: null,
...
export function summaryToArchivedRow(summary: WorkspaceSummary): WorkspaceRow {
	return {
		...
		prSyncState: summary.prSyncState ?? "none",
		prUrl: summary.prUrl ?? null,
		workspaceKind: summary.workspaceKind ?? "worktree",
...
export function rowToWorkspaceSummary(
	...
	return {
		...
		prSyncState: row.prSyncState ?? "none",
