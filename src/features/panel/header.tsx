	...
	return (
		<header className="relative z-20">
			<div
				...
				className="flex h-9 items-center justify-between gap-3 px-[18px] max-[960px]:px-0.5"
			...
			<div className="flex items-center px-4 pb-1 max-[960px]:pl-2.5 max-[960px]:pr-0.5">
