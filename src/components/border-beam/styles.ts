...
function getRightLineColorGradients(
	colorVariant: BorderBeamColorVariant,
	isDark: boolean,
	id: string,
): string {
			...
			const offsetYStr =
				c.offsetX === 0
					...
					: c.offsetX > 0
						? ` + ${c.offsetX}px`
						: ` - ${Math.abs(c.offsetX)}px`;
			return `radial-gradient(ellipse calc(${c.sizeH}px * var(--beam-h-${id})) calc(${c.sizeW}px * var(--beam-w-${id})) at calc(100%${offsetXStr}) calc(var(--beam-y-${id}) * 100%${offsetYStr}), ${c.color}, transparent)`;
		})
		.join(",\n       ");
}
...
function getRightLineInnerGradients(
	colorVariant: BorderBeamColorVariant,
	id: string,
): string {
	const data = lineInnerGradientData[colorVariant];
	return data
		.map((c) => {
			const offsetXStr = c.offsetY === 0 ? "" : ` - ${Math.abs(c.offsetY)}px`;
			const offsetYStr =
				c.offsetX === 0
					? ""
					: c.offsetX > 0
...
function getRightLineBloomGradients(
	colorVariant: BorderBeamColorVariant,
	isDark: boolean,
	id: string,
): string {
	...
	const thinW1 = isMono ? "42px" : "92px";
	const thinW2 = isMono ? "38px" : "72px";
	const thinW3 = isMono ? "40px" : "85px";
	const thinW4 = isMono ? "32px" : "60px";
	const thinH1 = isMono ? "12px" : "0.8px";
	const thinH2 = isMono ? "14px" : "2px";
	const thinH3 = isMono ? "12px" : "1.2px";
	const thinH4 = isMono ? "10px" : "0.6px";
	const thinLW = isMono ? "32px" : "60px";
	const glowDotC = isMono
		? "rgba(255, 255, 255, 0.5)"
		: "rgba(255, 255, 255, 1)";
	const glowDot20 = isMono
	...
	if (isDark) {
		return `radial-gradient(ellipse calc(${thinH1} * var(--beam-h-${id})) calc(${thinW1} * var(--beam-spike-${id})) at calc(100% - 2px) 8%, ${sc1}, ${sc1_mid} 30%, transparent 88%),
       radial-gradient(ellipse calc(35px * var(--beam-h-${id})) calc(10px * var(--beam-spike2-${id})) at calc(100% - 4px) 22%, ${sc2}, ${sc2_mid} 50%, transparent 95%),
       radial-gradient(ellipse calc(${thinH2} * var(--beam-h-${id})) calc(${thinW2} * (2 - var(--beam-spike-${id}))) at calc(100% - 3px) 36%, ${spikes[0].color1}, ${spikes[0].color2} 40%, transparent 90%),
       radial-gradient(ellipse calc(28px * var(--beam-h-${id})) calc(14px * var(--beam-spike2-${id})) at calc(100% - 2px) 50%, ${spikes[1].color1}, ${spikes[1].color2} 55%, transparent 96%),
       radial-gradient(ellipse calc(${thinH3} * var(--beam-h-${id})) calc(${thinW3} * (2 - var(--beam-spike2-${id}))) at calc(100% - 4px) 64%, ${spikes[2].color1}, ${spikes[2].color2} 35%, transparent 89%),
       radial-gradient(ellipse calc(45px * var(--beam-h-${id})) calc(7px * var(--beam-spike-${id})) at calc(100% - 2px) 78%, ${spikes[3].color1}, ${spikes[3].color2} 48%, transparent 94%),
       radial-gradient(ellipse calc(${thinH4} * var(--beam-h-${id})) calc(${thinW4} * (2 - var(--beam-spike-${id}))) at calc(100% - 3px) 92%, ${spikes[4].color1}, ${spikes[4].color2} 42%, transparent 91%),
       radial-gradient(ellipse calc(15px * var(--beam-spike2-${id})) calc(21px * var(--beam-spike-${id})) at calc(100% + 1px) calc(var(--beam-y-${id}) * 100%), ${glowDotC} 0%, ${glowDot20} 20%, ${glowDot50} 50%, transparent 100%),
       radial-gradient(ellipse calc(40px * var(--beam-h-${id})) calc(42px * var(--beam-w-${id})) at 100% calc(var(--beam-y-${id}) * 100%), ${glowAmbC} 0%, ${glowAmb25} 25%, ${glowAmb55} 55%, transparent 80%)`;
	}
	...
	const sc2_lt = isMono
		? attenuateSpike(spikeColors.secondary, 0.09)
		: withAlpha(spikeColors.secondary, 0.7);
	return `radial-gradient(ellipse calc(${thinH1} * var(--beam-h-${id})) calc(${thinW1} * var(--beam-spike-${id})) at calc(100% - 2px) 8%, ${sc1}, ${sc1_lt} 30%, transparent 88%),
       radial-gradient(ellipse calc(35px * var(--beam-h-${id})) calc(10px * var(--beam-spike2-${id})) at calc(100% - 4px) 22%, ${sc2}, ${sc2_lt} 50%, transparent 95%),
       radial-gradient(ellipse calc(${thinH2} * var(--beam-h-${id})) calc(${thinW2} * (2 - var(--beam-spike-${id}))) at calc(100% - 3px) 36%, ${spikes[0].color1}, ${spikes[0].color2} 40%, transparent 90%),
       radial-gradient(ellipse calc(28px * var(--beam-h-${id})) calc(14px * var(--beam-spike2-${id})) at calc(100% - 2px) 50%, ${spikes[1].color1}, ${spikes[1].color2} 55%, transparent 96%),
       radial-gradient(ellipse calc(${thinH3} * var(--beam-h-${id})) calc(${thinW3} * (2 - var(--beam-spike2-${id}))) at calc(100% - 4px) 64%, ${spikes[2].color1}, ${spikes[2].color2} 35%, transparent 89%),
       radial-gradient(ellipse calc(45px * var(--beam-h-${id})) calc(7px * var(--beam-spike-${id})) at calc(100% - 2px) 78%, ${spikes[3].color1}, ${spikes[3].color2} 48%, transparent 94%),
       radial-gradient(ellipse calc(${thinLW} * var(--beam-h-${id})) calc(${thinH4} * (2 - var(--beam-spike-${id}))) at calc(100% - 3px) 92%, ${spikes[4].color1}, ${spikes[4].color2} 42%, transparent 91%),
       radial-gradient(ellipse calc(32px * var(--beam-h-${id})) calc(50px * var(--beam-w-${id})) at 100% calc(var(--beam-y-${id}) * 100%), rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.18) 30%, rgba(0, 0, 0, 0.03) 60%, transparent 85%)`;
}
...
interface GenerateStylesOptions {
	...
	size: "sm" | "md" | "line";
	side: BorderBeamSide;
	travelDirection: BorderBeamTravelDirection;
	colorVariant: BorderBeamColorVariant;
...
export function generateBeamCSS(options: GenerateStylesOptions): string {
	const { side, size } = options;

	if (side === "right") {
		return generateRightLineVariantCSS(options);
	}

	if (side === "top") {
		return generateTopLineVariantCSS(options);
	}

	if (side === "bottom" || size === "line") {
...
@keyframes beam-hue-shift-bloom-${id} {
  ...
  100% { filter: blur(8px) hue-rotate(-${hueRange + 10}deg) brightness(${brightness.toFixed(2)}) saturate(${saturation.toFixed(2)}); }
	...
	const travelAnimationDirection =
		travelDirection === "alternate" ? " alternate" : "";
	const travelTiming =
		travelDirection === "alternate" ? "ease-in-out" : "linear";
	const edgeFadeAnimation =
...
[data-beam="${id}"][data-active] {
  animation:
    beam-travel-${id} ${duration}s ${travelTiming} infinite${travelAnimationDirection}${edgeFadeAnimation},
...
function generateTopLineVariantCSS(options: GenerateStylesOptions): string {
	const bottomCSS = generateLineVariantCSS(options);
	const { id } = options;
	let topCSS = bottomCSS
		.replaceAll("calc(100% + 1px)", "calc(0% - 1px)")
		.replaceAll("calc(100% + 2px)", "calc(0% - 2px)")
		.replaceAll("calc(100% + 3px)", "calc(0% - 3px)")
		.replaceAll("calc(100% + 4px)", "calc(0% - 4px)")
		.replaceAll("calc(100% - 1px)", "calc(0% + 1px)")
		.replaceAll("calc(100% - 2px)", "calc(0% + 2px)")
		.replaceAll("calc(100% - 3px)", "calc(0% + 3px)")
		.replaceAll("calc(100% - 4px)", "calc(0% + 4px)")
		.replaceAll("calc(100%)", "calc(0%)");

	topCSS = topCSS.replaceAll(
		`at calc(var(--beam-x-${id}) * 100%) 100%`,
		`at calc(var(--beam-x-${id}) * 100%) 0%`,
	);

	return topCSS;
}

function generateRightLineVariantCSS(options: GenerateStylesOptions): string {
	const {
		id,
		borderRadius,
		borderWidth,
...
@keyframes beam-hue-shift-bloom-${id} {
  ...
  100% { filter: blur(8px) hue-rotate(-${hueRange + 10}deg) brightness(${brightness.toFixed(2)}) saturate(${saturation.toFixed(2)}); }
	...
	const whiteHighlight = isDark
		? `radial-gradient(
        ellipse calc(28px * var(--beam-h-${id})) calc(24px * var(--beam-w-${id})) at calc(100% + 2px) calc(var(--beam-y-${id}) * 100%),
        rgba(255, 255, 255, 0.38) 0%,
        rgba(255, 255, 255, 0.12) 30%,
        transparent 65%
      )`
		: `radial-gradient(
        ellipse calc(28px * var(--beam-h-${id})) calc(35px * var(--beam-w-${id})) at calc(100% + 2px) calc(var(--beam-y-${id}) * 100%),
        rgba(0, 0, 0, 0.6) 0%,
        rgba(0, 0, 0, 0.25) 35%,
        transparent 70%
      )`;
	const colorGradients = getRightLineColorGradients(colorVariant, isDark, id);
	const innerGradients = getRightLineInnerGradients(colorVariant, id);
	const bloomGradients = getRightLineBloomGradients(colorVariant, isDark, id);
	const travelAnimationDirection =
		travelDirection === "alternate" ? " alternate" : "";
	const travelTiming =
		travelDirection === "alternate" ? "ease-in-out" : "linear";
...
[data-beam="${id}"][data-fading]::after {
  ...
  -webkit-mask:
    radial-gradient(
      ellipse calc(60px * var(--beam-h-${id})) calc(78px * var(--beam-w-${id})) at 100% calc(var(--beam-y-${id}) * 100%),
      white 0%, rgba(255, 255, 255, 0.5) 45%, transparent 100%
    ),
    linear-gradient(#fff 0 0) content-box,
    linear-gradient(#fff 0 0);
...
[data-beam="${id}"] [data-beam-bloom] {
  ...
  padding: 0;
  -webkit-mask: radial-gradient(
    ellipse calc(110px * var(--beam-h-${id})) calc(84px * var(--beam-w-${id})) at 100% calc(var(--beam-y-${id}) * 100%),
    white 0%, rgba(255, 255, 255, 0.5) 35%, transparent 100%
  );
  -webkit-mask-composite: source-over;
  mask: radial-gradient(
...
@keyframes beam-travel-${id} {
  0%   { --beam-y-${id}: 0.06;  --beam-w-${id}: 0.5; }
  10%  { --beam-y-${id}: 0.15;  --beam-w-${id}: 0.8; }
  20%  { --beam-y-${id}: 0.25;  --beam-w-${id}: 1.1; }
  30%  { --beam-y-${id}: 0.35;  --beam-w-${id}: 1.3; }
  40%  { --beam-y-${id}: 0.44;  --beam-w-${id}: 1.45; }
  50%  { --beam-y-${id}: 0.5;   --beam-w-${id}: 1.5; }
  60%  { --beam-y-${id}: 0.56;  --beam-w-${id}: 1.45; }
  70%  { --beam-y-${id}: 0.65;  --beam-w-${id}: 1.3; }
  80%  { --beam-y-${id}: 0.75;  --beam-w-${id}: 1.1; }
  90%  { --beam-y-${id}: 0.85;  --beam-w-${id}: 0.8; }
  100% { --beam-y-${id}: 0.94;  --beam-w-${id}: 0.5; }
}
